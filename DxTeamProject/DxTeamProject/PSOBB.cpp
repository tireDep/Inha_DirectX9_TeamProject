...
void CPSOBB::Setup(CAllocateHierarchy & ah)
{
...
//
//	//if (!tryAxis(one, two, (one.getAxis(0)), D, (0), penetration, best)) return 0;
//	//if (!tryAxis(one, two, (one.getAxis(1)), D, (1), penetration, best)) return 0;
//	//if (!tryAxis(one, two, (one.getAxis(2)), D, (2), penetration, best)) return 0;
//
//	//if (!tryAxis(one, two, (one.getAxis(0)), D, (0), penetration, best)) return 0;
//
//
