// DxObjectTool.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "DxObjectTool.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_DXOBJECTTOOL, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_DXOBJECTTOOL));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_DXOBJECTTOOL));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_DXOBJECTTOOL);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_MOVE:
		...
		MoveWindow(g_hMenuWnd, rtWindow.right-12, rtWindow.top+1, g_nDlgWidth, g_nDlgHeight, TRUE);
		//MoveWindow(g_hMenuWnd, rtWindow.right, rtWindow.top, )
    case WM_COMMAND:
        {
